...
const u8 gText_BirchGirl[] = _("EGIRL");
const u8 gText_DefaultNameStu[] = _("STU"); // TODO: REPLACE?
...
const u8 gText_ThisIsAPokemon[] = _("This is what we call a “GAMER.”{PAUSE 96}\p");
